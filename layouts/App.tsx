...
import { CommentOutlined, MenuUnfoldOutlined, MenuFoldOutlined } from '@ant-design/icons';
import React, { useState } from 'react';
import { Switch, Route, Link } from 'react-router-dom';
import Home from '@pages/Home';
import './App.css';
import BasicReact from '@pages/BasicReact';
import BasicVue from '@pages/BasicVue';
...
const App = () => {
  ...
  return (
    <Layout>
      ...
      <Layout>
        <Header className="site-layout-background" style={{ padding: 0, fontSize: '22px' }}>
